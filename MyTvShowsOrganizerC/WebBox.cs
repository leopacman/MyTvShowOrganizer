...
{
    public partial class WebBox : Form
    {
        private const int CS_DROPSHADOW = 0x00020000;
        private static WebBox _TranslateBox;
        ...
        //    return _buttonResult;
        //}
        public static void Show(string title, string webLink, string message = "")
        {
            TimerCursorOverButtonContructor();

            _TranslateBox = new WebBox();
            //_TranslateBox._lblMessage.Text = message;
            ...
            WebBox.InitButtons(Buttons.OK);

            _TranslateBox._translatorUrl = webLink;
            //TranslateBox.InitWebTranslatorUrl(webTranslator);
        ...
        //public static void Show(string message, string title, string webLink, AnimateStyle style)//  Buttons buttons, Icone icon,
        //{
        //    TimerCursorOverButtonContructor();
        //    WebBox.InitButtons(Buttons.OK);
        ...
        //    switch (style)
        //    {
        //        case WebBox.AnimateStyle.SlideDown:
        //            _TranslateBox.Size = new Size(formSize.Width, 0);
        //            _timer.Interval = 20;
        //            _timer.Tag = new AnimateWebBox(formSize, style);
        //            break;

        //        case WebBox.AnimateStyle.FadeIn:
        ...
        //        case WebBox.AnimateStyle.ZoomIn:
        ...
        //    AnimateWebBox animate = (AnimateWebBox)timer.Tag;
        ...
        //    {
        //        case TranslateBox.WebTranslator.Bing:
        //            _TranslateBox._translatorUrl = "https://www.bing.com/translator/";
        //            break;
        //        case TranslateBox.WebTranslator.Google:
        //            _TranslateBox._translatorUrl = "https://translate.google.com/";
        //            break;
        //        case TranslateBox.WebTranslator.Subtitle:
        //            _TranslateBox._translatorUrl = "http://www.subtitles4free.net/search-subtitles-";
        //            break;
    ...
    //    public WebBox.AnimateStyle Style;

    //    public AnimateWebBox(Size formSize, WebBox.AnimateStyle style)
    //    {
